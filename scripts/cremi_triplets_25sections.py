...
crag_sampleA = '/raid/julia/documents/Dropbox/best_effort/heuristic_25sections/sampleA_bestEffort.hdf'
crag_sampleB = '/raid/julia/documents/Dropbox/best_effort/heuristic_25sections/sampleB_bestEffort.hdf'
crag_sampleC = '/raid/julia/documents/Dropbox/best_effort/heuristic_25sections/sampleC_bestEffort.hdf'
...
root_output = '/raid/julia/projects/fragment_embedding/vanessa_crag/heuristics25/triplets_rank5/'
# root_output = '/raid/julia/projects/fragment_embedding/vanessa_crag/heuristics25/dummy/'
create_dir(root_output)
data_config = '/raid/julia/src/fragment_embedding/neuralimg/scripts/confs/data_25sections.conf'    # Change data settings according to needs
