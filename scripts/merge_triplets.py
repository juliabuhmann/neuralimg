...
files = ['/raid/julia/projects/fragment_embedding/vanessa_crag/heuristics100/triplets_rank4/sampleA.h5',
         '/raid/julia/projects/fragment_embedding/vanessa_crag/heuristics100/triplets_rank4/sampleB.h5',
         '/raid/julia/projects/fragment_embedding/vanessa_crag/heuristics100/triplets_rank4/sampleC.h5']
data_collection = []
for file in files:
    f = h5py.File(file, 'r')
    data = f['data'].value
...
dummy_file = '/raid/julia/projects/fragment_embedding/vanessa_crag/cremi_besteffort_van/triplets_toy/dummy.h5'

f = h5py.File(dummy_file, 'a')
del f['data']
f.create_dataset('data', data=data_collection, compression='gzip')
f.close()
