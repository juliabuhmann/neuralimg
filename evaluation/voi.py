...
def voi(reconstruction, groundtruth, ignore_reconstruction=[], ignore_groundtruth=[0]):
    ...
    Parameters
    ----------
    reconstruction : np.ndarray, int type, arbitrary shape
        A candidate segmentation.
    groundtruth : np.ndarray, int type, same shape as `seg`
        The ground truth segmentation.
    ignore_reconstruction, ignore_groundtruth : list of int, optional
